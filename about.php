...
<body>
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            ...
            <div class="col-5">
                <img src="img/marikost.PNG" alt="" class="img-thumbnail">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-5">
